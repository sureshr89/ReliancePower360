...
RSS_SOURCES = [
    ...
    ("Google News - Regulatory", "https://news.google.com/rss/search?q=%22Reliance+Power%22+regulatory+OR+SEBI+OR+NSE+OR+BSE&hl=en-IN&gl=IN&ceid=IN:en"),
...
RELEVANCE_TERMS = [
    "reliance power", "reliancepwr", "rosa power",
    "sasan power", "vidarbha industries power",
]

SECTOR_TERMS = [
    "power sector", "electricity", "thermal power",
    "renewable energy", "coal", "electricity demand",
    "power generation", "power tariff", "transmission",
]
